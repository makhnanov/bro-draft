...
<template>
  ...
  <div v-if="!isAreaSelector" :class="['sidebar', { collapsed: isSidebarCollapsed }]">
    ...
    <router-link to="/keyboard" class="nav-item">
        <svg viewBox="0 0 24 24" class="nav-icon">
            <rect x="2" y="4" width="20" height="16" rx="2" fill="none" stroke="currentColor" stroke-width="2"/>
            <line x1="6" y1="8" x2="6" y2="8.01" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="10" y1="8" x2="10" y2="8.01" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="14" y1="8" x2="14" y2="8.01" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="18" y1="8" x2="18" y2="8.01" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="6" y1="12" x2="6" y2="12.01" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="10" y1="12" x2="10" y2="12.01" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="14" y1="12" x2="14" y2="12.01" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="18" y1="12" x2="18" y2="12.01" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="7" y1="16" x2="17" y2="16" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
        </svg>
        <span class="nav-text">Keyboard</span>
    </router-link>
      <router-link to="/streaming" class="nav-item">
        <svg viewBox="0 0 24 24" class="nav-icon">
          <rect x="2" y="3" width="20" height="14" rx="2" fill="none" stroke="currentColor" stroke-width="2"/>
          <line x1="8" y1="21" x2="16" y2="21" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
          <line x1="12" y1="17" x2="12" y2="21" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
          <circle cx="12" cy="10" r="3" fill="none" stroke="currentColor" stroke-width="2"/>
          <path d="M8 10 L8 10" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
          <path d="M16 10 L16 10" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
        </svg>
