/**
 * Play a beep sound to indicate microphone activation (higher pitch, ascending)
 */
...
/**
 * Play a beep sound to indicate microphone deactivation (lower pitch, descending)
 */
export function playDeactivationBeep(): void {
    const audioContext = new AudioContext();
    const oscillator = audioContext.createOscillator();
    const gainNode = audioContext.createGain();
